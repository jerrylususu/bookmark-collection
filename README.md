- [All possible notations of IPv4 address](https://lucb1e.com/randomprojects/php/funnip.php?ip=8.8.8.8&link) URL 中的 IP 地址，数字部分可以用不同的进制表示，从而构造相同 IP 的诸多不同表示方法 #web#hack
